...
return {
  ...
  opts = {
    ...
    highlight = {
      ...
      multiline_context = 10, -- extra lines of context to show around the todo
  ...
  keys = {
    ...
    },
    {
      ...
      desc = "[s]earch [T]odos (TODO/FIX only)",
    },
    {
      "<leader>xt",
      "<cmd>TodoTrouble<cr>",
    ...
    },
    {
      ...
      desc = "trouble [T]odos (TODO/FIX only)",
    },
  },
}
