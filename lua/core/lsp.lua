  ...
  callback = function(event)
    ...
    if wk_ok then
      wk.add({
        ...
        { "<leader>lA", vim.lsp.buf.code_action, desc = "Range Code Actions", buffer = bufnr, mode = "v" },
        { "<leader>ls", vim.lsp.buf.signature_help, desc = "Display Signature Information", buffer = bufnr },
        { "<leader>lr", vim.lsp.buf.rename, desc = "Rename all references", buffer = bufnr },
        { "<leader>lf", vim.lsp.buf.format, desc = "Format", buffer = bufnr },
        { "<leader>lF", function() vim.lsp.buf.format({ range = true }) end, desc = "Format Range", buffer = bufnr, mode = "v" },
        { "<leader>Wa", vim.lsp.buf.add_workspace_folder, desc = "Workspace Add Folder", buffer = bufnr },
        { "<leader>Wr", vim.lsp.buf.remove_workspace_folder, desc = "Workspace Remove Folder", buffer = bufnr },
        {
          "<leader>Wl",
          function()
